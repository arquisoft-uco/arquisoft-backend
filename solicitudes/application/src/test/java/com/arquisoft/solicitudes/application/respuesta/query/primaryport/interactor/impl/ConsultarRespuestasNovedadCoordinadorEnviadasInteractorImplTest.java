...
class ConsultarRespuestasNovedadCoordinadorEnviadasInteractorImplTest {

    @Mock
    private ConsultarRespuestasNovedadCoordinadorEnviadasUseCase useCase;

    @Captor
    private ArgumentCaptor<RespuestaCriteria> criteriaCaptor;

    @InjectMocks
    private ConsultarRespuestasNovedadCoordinadorEnviadasInteractorImpl interactor;
    ...
    void debeDelegarEnElUseCaseConElCriteriaDelMapper_yRetornarSuResultado() {
        ...
        var query = ConsultarRespuestasNovedadCoordinadorEnviadasQuery.crear(coordinador, criterio);
