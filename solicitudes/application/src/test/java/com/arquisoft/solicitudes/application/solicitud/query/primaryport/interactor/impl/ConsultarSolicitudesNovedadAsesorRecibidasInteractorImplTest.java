...
class ConsultarSolicitudesNovedadAsesorRecibidasInteractorImplTest {

    @Mock
    private ConsultarSolicitudesNovedadAsesorRecibidasUseCase useCase;

    @Captor
    private ArgumentCaptor<SolicitudCriteria> criteriaCaptor;

    @InjectMocks
    private ConsultarSolicitudesNovedadAsesorRecibidasInteractorImpl interactor;
    ...
    void debeDelegarEnElUseCaseConElCriteriaDelMapper_yRetornarSuResultado() {
        ...
        var query = ConsultarSolicitudesNovedadAsesorRecibidasQuery.crear(asesor, criterio);
        ...
        var forzadoDestinatario = NodoFiltro.predicado(
                ...
                FiltroOperador.ES, asesor.toString());
        var forzadoTipo = NodoFiltro.predicado(
                SolicitudCriteria.Campo.TIPO_SOLICITUD_ID.getClave(),
                FiltroOperador.ES, TipoSolicitud.NOVEDAD_PARA_EL_ASESOR.getId());
