...
class ConsultarSolicitudesNovedadAsesorEnviadasInteractorImplTest {

    @Mock
    private ConsultarSolicitudesNovedadAsesorEnviadasUseCase useCase;

    @Captor
    private ArgumentCaptor<SolicitudCriteria> criteriaCaptor;

    @InjectMocks
    private ConsultarSolicitudesNovedadAsesorEnviadasInteractorImpl interactor;
