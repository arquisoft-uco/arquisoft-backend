...
public class ConsultarSolicitudesNovedadCoordinadorEnviadasUseCaseImpl
        implements ConsultarSolicitudesNovedadCoordinadorEnviadasUseCase {
    ...
    public PaginatedResult<SolicitudReadModel> ejecutar(SolicitudCriteria entrada) {
        logger.debug(SolicitudKey.LOG_CONSULTANDO_NOVEDAD_COORDINADOR_ENVIADAS,
        ...
        logger.debug(SolicitudKey.LOG_CONSULTA_NOVEDAD_COORDINADOR_ENVIADAS_COMPLETADA,
