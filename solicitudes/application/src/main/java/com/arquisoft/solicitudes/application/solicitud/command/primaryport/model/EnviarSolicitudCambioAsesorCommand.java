...
public record EnviarSolicitudCambioAsesorCommand(
        UUID remitenteUsuario,
        UUID destinatarioUsuario,
        String mensajeSolicitud
) {
    public EnviarSolicitudCambioAsesorCommand {
        mensajeSolicitud = UtilTexto.aplicarTrim(mensajeSolicitud);
    }

    public static EnviarSolicitudCambioAsesorCommand crear(
        ...
        return new EnviarSolicitudCambioAsesorCommand(
