...
public final class ConsultarRespuestasNovedadAsesorRecibidasMapper {

    private ConsultarRespuestasNovedadAsesorRecibidasMapper() {}

    public static RespuestaCriteria toCriteria(
            ConsultarRespuestasNovedadAsesorRecibidasQuery query) {
