...
@Component
public class EnviarSolicitudCambioAsesorValidatorImpl
        implements EnviarSolicitudCambioAsesorValidator {
    ...
    public EnviarSolicitudCambioAsesorValidatorImpl() {
    ...
    @Override
    public void validarAsignacionDestinatario(EnvioSolicitudCambioAsesorDomain envio,
