...
public class ConsultarRespuestasNovedadCoordinadorEnviadasUseCaseImpl
        implements ConsultarRespuestasNovedadCoordinadorEnviadasUseCase {
    ...
    public PaginatedResult<RespuestaReadModel> ejecutar(RespuestaCriteria entrada) {
        logger.debug(RespuestaKey.LOG_CONSULTANDO_NOVEDAD_COORDINADOR_ENVIADAS,
        ...
        logger.debug(RespuestaKey.LOG_CONSULTA_NOVEDAD_COORDINADOR_ENVIADAS_COMPLETADA,
