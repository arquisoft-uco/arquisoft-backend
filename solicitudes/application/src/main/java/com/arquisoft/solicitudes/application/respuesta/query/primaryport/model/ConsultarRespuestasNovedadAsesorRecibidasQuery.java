...
public record ConsultarRespuestasNovedadAsesorRecibidasQuery(
        UUID estudianteUsuario,
        ConsultaCriteriaQuery criterio
) {

    public static ConsultarRespuestasNovedadAsesorRecibidasQuery crear(
        ...
        return new ConsultarRespuestasNovedadAsesorRecibidasQuery(estudianteUsuario, criterio);
    }
}
