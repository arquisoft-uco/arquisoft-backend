...
public final class ConsultarRespuestasNovedadCoordinadorEnviadasMapper {

    private ConsultarRespuestasNovedadCoordinadorEnviadasMapper() {}

    public static RespuestaCriteria toCriteria(
            ConsultarRespuestasNovedadCoordinadorEnviadasQuery query) {
        var criterio = query.criterio();

        var forzadoDestinatario = NodoFiltro.predicado(
                RespuestaCriteria.Campo.DESTINATARIO_USUARIO_ID.getClave(), FiltroOperador.ES,
