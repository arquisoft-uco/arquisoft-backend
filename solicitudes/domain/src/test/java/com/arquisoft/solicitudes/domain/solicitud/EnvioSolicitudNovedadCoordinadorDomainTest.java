...
class EnvioSolicitudNovedadCoordinadorDomainTest {
    ...
    void debeAgruparLosTresObjetos_cuandoLosDatosSonValidos() {
        ...
        EnvioSolicitudNovedadCoordinadorDomain envio =
                EnvioSolicitudNovedadCoordinadorDomain.crear(solicitud, remitente, destinatario);
    ...
    void debeAcumularLosErrores_cuandoLosTresObjetosSonNulos() {
        ...
        DomainValidationException excepcion = assertThrows(DomainValidationException.class,
                () -> EnvioSolicitudNovedadCoordinadorDomain.crear(null, null, null));
