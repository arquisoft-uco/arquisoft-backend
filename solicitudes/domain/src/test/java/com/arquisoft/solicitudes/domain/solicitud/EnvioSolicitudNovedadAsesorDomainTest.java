...
class EnvioSolicitudNovedadAsesorDomainTest {
    ...
    void debeAgruparLosTresObjetos_cuandoLosDatosSonValidos() {
        ...
        EnvioSolicitudNovedadAsesorDomain envio =
                EnvioSolicitudNovedadAsesorDomain.crear(solicitud, remitente, destinatario);
    ...
    void debeAcumularLosErrores_cuandoLosTresObjetosSonNulos() {
        ...
        DomainValidationException excepcion = assertThrows(DomainValidationException.class,
                () -> EnvioSolicitudNovedadAsesorDomain.crear(null, null, null));
