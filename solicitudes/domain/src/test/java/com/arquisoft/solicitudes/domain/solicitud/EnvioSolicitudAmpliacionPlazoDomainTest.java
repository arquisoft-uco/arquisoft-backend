...
class EnvioSolicitudAmpliacionPlazoDomainTest {
    ...
    void debeAgruparLosTresObjetos_cuandoLosDatosSonValidos() {
        ...
        EnvioSolicitudAmpliacionPlazoDomain envio =
                EnvioSolicitudAmpliacionPlazoDomain.crear(solicitud, remitente, destinatario);
    ...
    void debeAcumularLosErrores_cuandoLosTresObjetosSonNulos() {
        ...
        DomainValidationException excepcion = assertThrows(DomainValidationException.class,
                () -> EnvioSolicitudAmpliacionPlazoDomain.crear(null, null, null));
