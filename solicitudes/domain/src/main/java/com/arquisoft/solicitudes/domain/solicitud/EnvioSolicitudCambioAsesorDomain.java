...
public final class EnvioSolicitudCambioAsesorDomain {

    private SolicitudDomain solicitud;
    private RemitenteDomain remitente;
    private DestinatarioDomain destinatario;

    private EnvioSolicitudCambioAsesorDomain() {}

    public static EnvioSolicitudCambioAsesorDomain crear(SolicitudDomain solicitud,
                                                         RemitenteDomain remitente,
                                                         DestinatarioDomain destinatario) {
        var envio = new EnvioSolicitudCambioAsesorDomain();
