...
public final class EnvioSolicitudNovedadCoordinadorDomain {

    private SolicitudDomain solicitud;
    private RemitenteDomain remitente;
    private DestinatarioDomain destinatario;

    private EnvioSolicitudNovedadCoordinadorDomain() {}

    public static EnvioSolicitudNovedadCoordinadorDomain crear(SolicitudDomain solicitud,
                                                               RemitenteDomain remitente,
                                                               DestinatarioDomain destinatario) {
        var envio = new EnvioSolicitudNovedadCoordinadorDomain();
