...
public final class EnvioSolicitudNovedadAsesorDomain {

    private SolicitudDomain solicitud;
    private RemitenteDomain remitente;
    private DestinatarioDomain destinatario;

    private EnvioSolicitudNovedadAsesorDomain() {}

    public static EnvioSolicitudNovedadAsesorDomain crear(SolicitudDomain solicitud,
                                                          RemitenteDomain remitente,
                                                          DestinatarioDomain destinatario) {
        var envio = new EnvioSolicitudNovedadAsesorDomain();
