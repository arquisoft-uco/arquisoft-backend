...
public final class SolicitudAmpliacionPlazoEnviadaEvent extends DomainEvent {

    public static final String EVENT_TOPIC = EventTopics.Solicitudes.AMPLIACION_PLAZO_ENVIADA;
    public static final String EVENT_TYPE = "SolicitudAmpliacionPlazoEnviadaEvent";
    ...
    public SolicitudAmpliacionPlazoEnviadaEvent(UUID solicitudId, String remitenteNombre,
