...
// STUB — TODO(HU-081/HU-082/HU-083/HU-084): la comprobacion real es una consulta sincrona a `proyectos`
...
public class AsignacionProyectoOutputAdapter implements AsignacionProyectoOutputPort {
    ...
    @Override
    public boolean esResponsableAsignado(UUID estudianteUsuario, UUID responsableUsuario) {
        logger.warn(SolicitudKey.LOG_ASIGNACION_NO_VERIFICADA, responsableUsuario, estudianteUsuario);
        return true;
    }
}
