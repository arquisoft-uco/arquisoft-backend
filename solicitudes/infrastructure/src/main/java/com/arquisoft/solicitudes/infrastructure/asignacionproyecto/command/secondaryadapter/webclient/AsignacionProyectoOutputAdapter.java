...
// ("Synchronous cross-context queries" / "Known deviations").
@Component
...
public class AsignacionProyectoOutputAdapter implements AsignacionProyectoOutputPort {
    ...
    public boolean esCoordinadorAsignado(UUID estudianteUsuario, UUID coordinadorUsuario) {
        logger.warn(Mensajes.obtener(SolicitudKey.LOG_ASIGNACION_NO_VERIFICADA),
                coordinadorUsuario, estudianteUsuario);
        return true;
    }
}
