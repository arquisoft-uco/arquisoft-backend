...
@WebMvcTest(ResponderSolicitudNovedadCoordinadorController.class)
@Import({AppLoggerConfig.class, GlobalAppExceptionHandler.class, TrazabilidadConfig.class,
        ResponderSolicitudNovedadCoordinadorControllerTest.TestSecurityConfig.class})
class ResponderSolicitudNovedadCoordinadorControllerTest {

    private static final String RUTA = "/solicitudes/novedad-coordinador/%s/respuesta";
    ...
    @MockitoBean
    private ResponderSolicitudNovedadCoordinadorInteractor interactor;
    ...
    void debe201YTomarElCoordinadorDelJwt_cuandoLaPeticionEsValida() throws Exception {
        ...
        mockMvc.perform(post(RUTA.formatted(solicitud))
                        ...
                        .with(jwtDe(coordinador, SolicitudesAuthorities.RESPUESTA_NOVEDAD_COORDINADOR_CREATE)))
    ...
    void debe400_cuandoElIdDeLaSolicitudNoEsUuid() throws Exception {
        mockMvc.perform(post("/solicitudes/novedad-coordinador/no-es-uuid/respuesta")
                        .contentType(MediaType.APPLICATION_JSON)
