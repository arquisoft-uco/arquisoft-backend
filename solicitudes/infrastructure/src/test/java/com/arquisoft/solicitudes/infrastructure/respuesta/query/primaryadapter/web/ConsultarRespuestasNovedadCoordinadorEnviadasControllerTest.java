...
@WebMvcTest(ConsultarRespuestasNovedadCoordinadorEnviadasController.class)
@Import({AppLoggerConfig.class, GlobalAppExceptionHandler.class, TrazabilidadConfig.class,
        ConsultarRespuestasNovedadCoordinadorEnviadasControllerTest.TestSecurityConfig.class})
class ConsultarRespuestasNovedadCoordinadorEnviadasControllerTest {

    private static final String RUTA = "/solicitudes/novedad-coordinador/respuestas/enviadas";
    ...
    @MockitoBean
    private ConsultarRespuestasNovedadCoordinadorEnviadasInteractor interactor;
    ...
    void debeRetornar200ConPaginaVacia_cuandoConsultaSinBody() throws Exception {
        ...
        mockMvc.perform(post(RUTA)
                        ...
                        .with(jwtDe(UUID.randomUUID(),
                                SolicitudesAuthorities.RESPUESTA_NOVEDAD_COORDINADOR_ENVIADA_VIEW)))
    ...
    void debeSerializarRespuestaResponseDTOConSolicitudEmbebida_yTomarElCoordinadorDelJwt() throws Exception {
        ...
        mockMvc.perform(post(RUTA)
                ...
                .andExpect(jsonPath("$.content[0].solicitud.tipoSolicitudNombre")
                        .value("Novedad para el Coordinador"))
                ...
                .andExpect(jsonPath("$.content[0].solicitud.destinatario.nombre").value("Coordinadora Uno"))
                .andExpect(jsonPath("$.content[0].solicitud.destinatario.email").value("coord1@uco.edu.co"));

        // Assert
        var captor = ArgumentCaptor.forClass(ConsultarRespuestasNovedadCoordinadorEnviadasQuery.class);
