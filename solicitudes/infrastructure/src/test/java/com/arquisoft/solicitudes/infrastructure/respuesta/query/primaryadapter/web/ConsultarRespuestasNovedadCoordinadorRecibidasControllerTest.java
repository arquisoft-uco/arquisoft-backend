...
@WebMvcTest(ConsultarRespuestasNovedadCoordinadorRecibidasController.class)
@Import({AppLoggerConfig.class, GlobalAppExceptionHandler.class, TrazabilidadConfig.class,
        ConsultarRespuestasNovedadCoordinadorRecibidasControllerTest.TestSecurityConfig.class})
class ConsultarRespuestasNovedadCoordinadorRecibidasControllerTest {

    private static final String RUTA = "/solicitudes/novedad-coordinador/respuestas/recibidas";
    ...
    @MockitoBean
    private ConsultarRespuestasNovedadCoordinadorRecibidasInteractor interactor;
    ...
    void debeSerializarRespuestaResponseDTOConSolicitudEmbebida_yTomarElEstudianteDelJwt() throws Exception {
        ...
        // Assert
        var captor = ArgumentCaptor.forClass(ConsultarRespuestasNovedadCoordinadorRecibidasQuery.class);
