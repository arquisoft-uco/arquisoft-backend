...
class EstudianteAgregadoPayloadTest {

    private final tools.jackson.databind.json.JsonMapper mapper =
            new RabbitMQConfig().rabbitObjectMapper();

    private static final class EstudianteAgregadoEventoDePrueba extends DomainEvent {
        ...
        private EstudianteAgregadoEventoDePrueba(
                UUID usuario, String identificador, String nombre, String email) {
            super(EventTopics.Usuarios.ESTUDIANTE_AGREGADO, "EstudianteAgregadoEvent");
    ...
    void debeConservarIdEventoYOcurridoEn_cuandoSeLeeElEventoPublicado() {
        // Arrange
        var evento = new EstudianteAgregadoEventoDePrueba(
                UUID.randomUUID(), "20161020123", "Ana Estudiante", "ana@uco.edu.co");

        // Act
        var payload = mapper.readValue(
                mapper.writeValueAsString(evento), EstudianteAgregadoPayload.class);
    ...
    void debeDeserializarConNull_cuandoFaltaUnCampoNuevo() {
        ...
        String json = """
                {"idEvento":"evt-1","usuario":"11111111-1111-1111-1111-111111111111",
                 "identificador":"20161020123","nombre":"Ana Estudiante"}
                """;

        // Act
        var payload = mapper.readValue(json, EstudianteAgregadoPayload.class);
