...
class AsesorAgregadoConsumerTest {
    ...
    private AsesorAgregadoConsumer consumer;

    @BeforeEach
    void setUp() {
        consumer = new AsesorAgregadoConsumer(
    ...
    void debeInvocarElInteractor_cuandoLlegaElEvento() throws Exception {
        // Act
        consumer.onAsesorAgregado(mensajeCon(UUID.randomUUID().toString(), 1L), channel);
    ...
    void debeEnviarNackSinReencolar_cuandoElPayloadEsEnvenenado() throws Exception {
        ...
        // Act
        consumer.onAsesorAgregado(mensajeCon(UUID.randomUUID().toString(), 2L), channel);
    ...
    void debeConfirmarElMensaje_cuandoElResultadoEsDescartada() throws Exception {
        ...
        // Act
        consumer.onAsesorAgregado(mensajeCon(UUID.randomUUID().toString(), 3L), channel);
