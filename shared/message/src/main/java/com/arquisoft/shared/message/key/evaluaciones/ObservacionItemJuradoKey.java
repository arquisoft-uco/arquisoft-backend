...
public enum ObservacionItemJuradoKey implements ClaveMensaje {
    ...
    LOG_VERIFICACION_REGISTRAR("evaluaciones.aplicacion.observacionitemjurado.log.verificacion-registrar", 4),
    ...
    ERROR_EVALUACION_CUANTITATIVA_JURADO_NO_PERTENECE_JURADO(
            "evaluaciones.dominio.observacionitemjurado.error.evaluacion-no-pertenece-jurado", 1),
