...
public enum FichaPerfilKey implements ClaveMensaje {
    ...
    LOG_VALIDACION_SUPERADA("fichas.aplicacion.fichaperfil.log.validacion-superada", 1),
    LOG_REGISTRADA("fichas.aplicacion.fichaperfil.log.registrada", 1),
    LOG_REGISTRO_COMPLETADO("fichas.aplicacion.fichaperfil.log.registro-completado", 2),
