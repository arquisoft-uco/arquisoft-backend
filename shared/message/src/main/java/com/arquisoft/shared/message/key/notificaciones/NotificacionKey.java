...
public enum NotificacionKey implements ClaveMensaje {
    ...
    LOG_EVENTO_DUPLICADO("notificaciones.aplicacion.notificacion.log.evento-duplicado", 0),
    LOG_ENVIADA("notificaciones.aplicacion.notificacion.log.enviada", 0),
    LOG_FALLIDA("notificaciones.aplicacion.notificacion.log.fallida", 0);
