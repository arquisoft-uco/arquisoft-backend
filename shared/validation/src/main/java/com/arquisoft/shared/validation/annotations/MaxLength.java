 ...
 * no puede superar el valor indicado en {@link #value()}.
 *
 * <p>Documenta la invariante de dominio correspondiente al guard
 * {@code DomainValidator.maxLength}. La evaluación se realiza sobre
...
public @interface MaxLength {
    ...
    /** Longitud máxima permitida (inclusive) después de aplicar trim. */
    int value();

    /** Código de error que se registrará en {@code ValidationResult}. */
    String errorCode() default "LONGITUD_MAXIMA_EXCEDIDA";
}
