...
public class MessageCatalogConfig {
    ...
    /**
     * Construye el catálogo y lo instala también en la fachada estática {@link Messages}, de modo
    ...
    public MessageCatalog messageCatalog() {
        MessageCatalog catalogo = ResourceBundleMessageCatalog.porDefecto();
        Messages.instalar(catalogo);
        return catalogo;
    }
}
