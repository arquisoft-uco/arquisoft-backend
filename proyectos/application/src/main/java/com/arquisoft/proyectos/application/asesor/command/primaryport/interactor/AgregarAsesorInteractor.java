package com.arquisoft.proyectos.application.asesor.command.primaryport.interactor;
...
public interface AgregarAsesorInteractor
        extends Interactor<AgregarAsesorCommand, AgregacionAsesorResult> {
}
