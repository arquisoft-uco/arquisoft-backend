...
import com.arquisoft.proyectos.application.estudiante.command.result.mapper.ActualizacionEstudianteResultMapper;
...
public class ActualizarEstudianteUseCaseImpl implements ActualizarEstudianteUseCase {
    ...
    public ActualizacionEstudianteResult ejecutar(EstudianteDomain entrada) {
        ...
        logger.debug(EstudianteProyectosKey.LOG_VERIFICACION_ACTUALIZAR, entrada.getId(), !vigente.esVacio());
