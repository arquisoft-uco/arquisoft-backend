...
public class CoordinadorProyectosCommandOutputAdapter implements CoordinadorOutputPort {

    private final CoordinadorProyectosCommandRepository coordinadorCommandRepository;
