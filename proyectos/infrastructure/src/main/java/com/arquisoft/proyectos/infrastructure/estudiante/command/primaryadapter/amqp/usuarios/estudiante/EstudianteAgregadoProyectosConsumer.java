...
@Component
public class EstudianteAgregadoProyectosConsumer extends AbstractEventConsumer {

    private final AgregarEstudianteProyectosInteractor agregarEstudianteProyectosInteractor;
    private final AppLogger logger;

    public EstudianteAgregadoProyectosConsumer(
            AgregarEstudianteProyectosInteractor agregarEstudianteProyectosInteractor,
            @Qualifier("rabbitObjectMapper") ObjectMapper objectMapper,
            AppLogger logger,
            GestorTraza gestorTraza) {
        super(objectMapper, gestorTraza);
        this.agregarEstudianteProyectosInteractor = agregarEstudianteProyectosInteractor;
        this.logger = logger;
    }
    ...
    public void onEstudianteAgregado(Message message, Channel channel) throws IOException {
        withCorrelation(message, channel, () -> {
            ...
            var resultado = agregarEstudianteProyectosInteractor.ejecutar(AgregarEstudianteCommand.crear(
