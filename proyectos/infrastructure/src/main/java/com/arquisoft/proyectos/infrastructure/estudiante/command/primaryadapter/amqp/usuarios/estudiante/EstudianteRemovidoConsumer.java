...
public class EstudianteRemovidoConsumer extends AbstractEventConsumer {
    ...
    @RabbitListener(queues = ProyectosUsuariosQueueConfig.ESTUDIANTE_REMOVIDO_QUEUE)
    public void onEstudianteRemovido(Message message, Channel channel) throws IOException {
        withCorrelation(message, channel, () -> {
            ...
            logger.info(EstudianteProyectosKey.LOG_REMOVIDO_RECIBIDO, payload.idEvento(), payload.usuario());
            ...
            switch (resultado) {
                case RemocionEstudianteResult.Removida removida ->
                        logger.info(EstudianteProyectosKey.LOG_REMOVIDO, removida.estudiante());
                case RemocionEstudianteResult.Lapida lapida ->
                        logger.info(EstudianteProyectosKey.LOG_LAPIDA, lapida.estudiante());
                case RemocionEstudianteResult.Descartada descartada ->
                        logger.debug(EstudianteProyectosKey.LOG_REMOCION_DESCARTADA,
