...
public class EstudianteProyectosCommandOutputAdapter implements EstudianteOutputPort {

    private final EstudianteProyectosCommandRepository estudianteCommandRepository;
