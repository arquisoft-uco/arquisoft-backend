...
@DataJpaTest
class EstudianteProyectosCommandOutputAdapterTest {

    @Autowired
    private EstudianteProyectosCommandRepository estudianteCommandRepository;
    ...
    void debeGuardarEstudiante_cuandoSePersiste() {
        // Arrange
        var adapter = new EstudianteProyectosCommandOutputAdapter(estudianteCommandRepository, logger);
