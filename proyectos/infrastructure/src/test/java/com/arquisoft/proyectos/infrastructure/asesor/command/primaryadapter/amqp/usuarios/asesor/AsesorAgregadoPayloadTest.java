...
class AsesorAgregadoPayloadTest {

    private final tools.jackson.databind.json.JsonMapper mapper =
            new RabbitMQConfig().rabbitObjectMapper();

    private static final class AsesorAgregadoEventoDePrueba extends DomainEvent {
        ...
        private AsesorAgregadoEventoDePrueba(
                UUID usuario, String identificador, String nombre, String email) {
            super(EventTopics.Usuarios.ASESOR_AGREGADO, "AsesorAgregadoEvent");
    ...
    void debeConservarIdEventoYOcurridoEn_cuandoSeLeeElEventoPublicado() {
        // Arrange
        var evento = new AsesorAgregadoEventoDePrueba(
                UUID.randomUUID(), "20161020123", "Ana Perez", "ana@uco.edu.co");

        // Act
        var payload = mapper.readValue(
                mapper.writeValueAsString(evento), AsesorAgregadoPayload.class);
    ...
    void debeDeserializarConNull_cuandoFaltaUnCampoNuevo() {
        ...
        // Act
        var payload = mapper.readValue(json, AsesorAgregadoPayload.class);
