...
import com.arquisoft.seguridad.application.auth.command.interactor.RefrescarTokenInteractor;
...
@WebMvcTest(controllers = AutenticacionCommandControlador.class,
...
@Import({GlobalAppExceptionHandler.class, CatalogoMensajesConfig.class,
        AutenticacionCommandControladorWebTest.TestSeguridadConfig.class})
class AutenticacionCommandControladorWebTest {
