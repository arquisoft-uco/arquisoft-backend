package com.arquisoft.seguridad.infrastructure.usuario.command.adapter.in.web;

import com.arquisoft.seguridad.application.usuario.command.port.in.CrearUsuarioInputPort;
import com.arquisoft.seguridad.infrastructure.usuario.command.adapter.in.web.dto.CrearUsuarioRequestDTO;
import com.arquisoft.seguridad.infrastructure.usuario.command.adapter.in.web.dto.CrearUsuarioResponseDTO;
...
@Tag(name = "Seguridad - Usuarios", description = "Gestion de usuarios del sistema")
