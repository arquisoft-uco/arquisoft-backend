...
public record IdentidadToken(
    ...
    public IdentidadToken {
        if (identidadId == null || identidadId.isBlank()) {
            throw new DomainException(Mensajes.obtener(IdentidadKey.ERROR_ID_REQUERIDO),
                    SeguridadCodes.Identidad.IDENTIDAD_ID_REQUERIDO);
        }
        if (correo == null || correo.isBlank()) {
            throw new DomainException(Mensajes.obtener(IdentidadKey.ERROR_CORREO_REQUERIDO),
