...
class EstudianteProyectoAsignadoConsumerTest {
    ...
    private EstudianteProyectoAsignadoConsumer adapter;

    private void crearAdapter() {
        adapter = new EstudianteProyectoAsignadoConsumer(
    ...
    @Test
    void debeSincronizarComoAsignacionActiva_yConfirmarElMensaje() throws Exception {
        // Arrange
        crearAdapter();
        ...
        // Act
        adapter.onEstudianteProyectoAsignado(mensajeCon(proyecto.toString(), estudiante.toString(), 1L), channel);
    ...
    @Test
    void debeEnviarNackSinReencolar_cuandoElPayloadTraeUnEstudianteIdMalformado() throws Exception {
        // Arrange
        crearAdapter();

        // Act
        adapter.onEstudianteProyectoAsignado(
                mensajeCon(UUID.randomUUID().toString(), "no-es-un-uuid", 2L), channel);
