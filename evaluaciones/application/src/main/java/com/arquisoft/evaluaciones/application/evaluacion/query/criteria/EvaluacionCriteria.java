...
public final class EvaluacionCriteria extends QueryCriteria {

    public enum Campo {
        ESTADO("estado", true, true),
        PROYECTO("proyecto", true, true),
        ENTREGABLE_ID("entregableId", true, false);
    ...
    private EvaluacionCriteria(Builder b) {
        super(b);
    }
    ...
    public static final class Builder extends QueryCriteria.BaseBuilder<Builder> {
        ...
        public EvaluacionCriteria build() {
            return new EvaluacionCriteria(this);
        }
    }
}
