...
public enum TipoNotificacionEvento {
    ...
    SOLICITUD_NOVEDAD_COORDINADOR_RESPONDIDA("SOLICITUD_NOVEDAD_COORDINADOR_RESPONDIDA"),
    SOLICITUD_NOVEDAD_COORDINADOR_ESTADO_MODIFICADO("SOLICITUD_NOVEDAD_COORDINADOR_ESTADO_MODIFICADO"),
