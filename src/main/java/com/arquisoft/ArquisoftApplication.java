...
// simple repetido (p. ej. RegistrarUsuarioUseCaseImpl, UsuarioCommandOutputAdapter). El generador
// por defecto los nombra por nombre simple y colisionan al escanear com.arquisoft.**. FQN da a
// cada bean un nombre unico (su clase completa). No afecta a los
