...
import com.arquisoft.fichas.application.estudiante.command.result.mapper.RemocionEstudianteResultMapper;
...
public class RemoverEstudianteUseCaseImpl implements RemoverEstudianteUseCase {
    ...
    public RemocionEstudianteResult ejecutar(EstudianteDomain entrada) {
        ...
        logger.debug(EstudianteKey.LOG_VERIFICACION_REMOVER, entrada.getId(), !vigente.esVacio());
