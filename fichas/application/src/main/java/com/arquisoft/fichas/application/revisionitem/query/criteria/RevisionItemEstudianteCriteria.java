...
public final class RevisionItemEstudianteCriteria extends QueryCriteria {

    public enum Campo {
        ITEM            ("item",           true,  false),
        ESTADO_REVISION ("estadoRevision", true,  true),
        ESTUDIANTE_ID   ("estudianteId",   true,  false);
    ...
    private RevisionItemEstudianteCriteria(Builder b) {
        super(b);
    }
    ...
    public static final class Builder extends QueryCriteria.BaseBuilder<Builder> {
        ...
        public RevisionItemEstudianteCriteria build() {
            return new RevisionItemEstudianteCriteria(this);
        }
    }
}
