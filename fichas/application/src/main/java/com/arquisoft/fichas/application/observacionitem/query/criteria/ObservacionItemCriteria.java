...
public final class ObservacionItemCriteria extends QueryCriteria {

    public enum Campo {
        REVISION_ITEM               ("revisionItem",              true,  false),
        ESTADO_OBSERVACION_REVISION ("estadoObservacionRevision", true,  true),
    ...
    private ObservacionItemCriteria(Builder b) {
        super(b);
    }
    ...
    public static final class Builder extends QueryCriteria.BaseBuilder<Builder> {
        ...
        public ObservacionItemCriteria build() {
            return new ObservacionItemCriteria(this);
        }
    }
}
