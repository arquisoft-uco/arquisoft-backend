...
public class ModificarFichaPerfilValidatorImpl implements ModificarFichaPerfilValidator {
    ...
    private final EstudiantePropietarioFichaRule estudiantePropietarioFichaRule = new EstudiantePropietarioFichaRuleImpl();
    private final FichaPerfilTituloUnicoRule fichaPerfilTituloUnicoRule = new FichaPerfilTituloUnicoRuleImpl();
