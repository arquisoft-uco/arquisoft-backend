...
class ConsultarObservacionesItemAsesorInteractorImplTest {

    @Mock
    private ConsultarObservacionesItemAsesorUseCase consultarObservacionesItemAsesorUseCase;

    @Captor
    private ArgumentCaptor<ObservacionItemCriteria> criteriaCaptor;

    @InjectMocks
    private ConsultarObservacionesItemAsesorInteractorImpl interactor;
    ...
    void debeDelegarEnUseCaseConElCriteriaDelMapper_yRetornarSuResultado() {
        ...
        PaginatedResult<ObservacionItemReadModel> resultadoEsperado = PaginatedResult.of(List.of(), 0, 10, 0L);
        when(consultarObservacionesItemAsesorUseCase.ejecutar(any(ObservacionItemCriteria.class)))
        ...
        verify(consultarObservacionesItemAsesorUseCase).ejecutar(criteriaCaptor.capture());
