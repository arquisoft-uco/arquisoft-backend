...
class ConsultarRevisionesItemAsesorInteractorImplTest {

    @Mock
    private ConsultarRevisionesItemAsesorUseCase consultarRevisionesItemAsesorUseCase;

    @Captor
    private ArgumentCaptor<RevisionItemCriteria> criteriaCaptor;

    @InjectMocks
    private ConsultarRevisionesItemAsesorInteractorImpl interactor;
    ...
    void debeDelegarEnUseCaseConElCriteriaDelMapper_yRetornarSuResultado() {
        ...
        when(consultarRevisionesItemAsesorUseCase.ejecutar(any(RevisionItemCriteria.class)))
        ...
        verify(consultarRevisionesItemAsesorUseCase).ejecutar(criteriaCaptor.capture());
