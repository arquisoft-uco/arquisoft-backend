...
class ConsultarObservacionesItemAsesorRequestMapperTest {

    @Test
    void debeMapearDtoYAsesorFichaAQuery_cuandoDtoTieneOrden() {
        // Arrange
        ...
        // Act
        var query = ConsultarObservacionesItemAsesorRequestMapper.toQuery(dto, asesorFicha);
        ...
        assertThat(query.criterio().ordenamiento().get(0).getCampo()).isEqualTo("estadoObservacionRevision");
    ...
    void debeAplicarValoresPorDefecto_cuandoDtoEsNulo() {
        ...
        // Act
        var query = ConsultarObservacionesItemAsesorRequestMapper.toQuery(null, asesorFicha);
