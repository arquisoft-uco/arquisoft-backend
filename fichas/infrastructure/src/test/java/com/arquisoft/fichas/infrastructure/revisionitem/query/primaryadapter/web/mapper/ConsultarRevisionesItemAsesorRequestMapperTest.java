...
class ConsultarRevisionesItemAsesorRequestMapperTest {
    ...
    void debeMapearDtoYAsesorFichaAQuery_cuandoDtoTieneFiltrosYOrden() {
        ...
        // Act
        var query = ConsultarRevisionesItemAsesorRequestMapper.toQuery(dto, asesorFicha);
    ...
    void debeAplicarValoresPorDefecto_cuandoDtoEsNulo() {
        ...
        // Act
        var query = ConsultarRevisionesItemAsesorRequestMapper.toQuery(null, asesorFicha);
