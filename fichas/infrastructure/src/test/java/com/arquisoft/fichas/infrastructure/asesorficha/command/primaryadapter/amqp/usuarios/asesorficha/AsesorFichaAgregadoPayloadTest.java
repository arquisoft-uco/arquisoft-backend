...
class AsesorFichaAgregadoPayloadTest {

    private final tools.jackson.databind.json.JsonMapper mapper =
            new RabbitMQConfig().rabbitObjectMapper();

    private static final class AsesorFichaAgregadoEventoDePrueba extends DomainEvent {
        ...
        private AsesorFichaAgregadoEventoDePrueba(
                UUID usuario, String identificador, String nombre, String email) {
            super(EventTopics.Usuarios.ASESOR_FICHA_AGREGADO, "AsesorFichaAgregadoEvent");
    ...
    void debeConservarIdEventoYOcurridoEn_cuandoSeLeeElEventoPublicado() {
        // Arrange
        var evento = new AsesorFichaAgregadoEventoDePrueba(
                UUID.randomUUID(), "20161020123", "Ana Perez", "ana@uco.edu.co");

        // Act
        var payload = mapper.readValue(
                mapper.writeValueAsString(evento), AsesorFichaAgregadoPayload.class);
    ...
    void debeDeserializarConNull_cuandoFaltaUnCampoNuevo() {
        ...
        // Act
        var payload = mapper.readValue(json, AsesorFichaAgregadoPayload.class);
