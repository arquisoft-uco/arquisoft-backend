...
@WebMvcTest(ConsultarRevisionesItemAsesorController.class)
@Import({GlobalAppExceptionHandler.class, TrazabilidadConfig.class,
        ConsultarRevisionesItemAsesorControllerTest.TestSecurityConfig.class})
class ConsultarRevisionesItemAsesorControllerTest {
    ...
    @MockitoBean
    private ConsultarRevisionesItemAsesorInteractor consultarRevisionesItemAsesorInteractor;
    ...
    void debeRetornar200ConPagina_cuandoConsultaValida() throws Exception {
        ...
        when(consultarRevisionesItemAsesorInteractor.ejecutar(any(ConsultarRevisionesItemAsesorQuery.class)))
        ...
        // Act & Assert
        mockMvc.perform(post("/fichas-perfil/revisiones-item/asesor")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(body)
                        .with(SecurityMockMvcRequestPostProcessors.jwt()
                                .jwt(j -> j.subject(ASESOR_ID.toString()))
                                .authorities(new SimpleGrantedAuthority(FichasAuthorities.REVISION_ITEM_ASESOR_VIEW))))
    ...
    @Test
    void debeRetornar200ConPaginaVacia_cuandoAsesorSinRevisiones() throws Exception {
        // Arrange
        when(consultarRevisionesItemAsesorInteractor.ejecutar(any(ConsultarRevisionesItemAsesorQuery.class)))
    ...
    void debeRetornar400_cuandoElArbolDeFiltrosReferenciaUnCampoNoDeclarado() throws Exception {
        // Arrange — "tituloProyecto" no está declarado en RevisionItemCriteria.Campo, así que el
        // Mapper (dentro del Interactor real, mockeado aquí) rechaza la construcción del Criteria.
        when(consultarRevisionesItemAsesorInteractor.ejecutar(any(ConsultarRevisionesItemAsesorQuery.class)))
    ...
    @Test
    void debeRetornar403_cuandoSinClientRoleRevisionItemAsesorView() throws Exception {
        // Act & Assert
        mockMvc.perform(post("/fichas-perfil/revisiones-item/asesor")
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(SecurityMockMvcRequestPostProcessors.jwt()
