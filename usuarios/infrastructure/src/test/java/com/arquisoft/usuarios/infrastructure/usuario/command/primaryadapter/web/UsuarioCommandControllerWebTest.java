...
class UsuarioCommandControllerWebTest {
    ...
    void debeRetornar201_cuandoBodyEsValido() throws Exception {
        ...
        when(crearUsuarioInteractor.ejecutar(any(CrearUsuarioCommand.class))).thenReturn(idEsperado);
    ...
    void debeEnlazarTodosLosCampos_cuandoBodyEsValido() throws Exception {
        // Arrange
        when(crearUsuarioInteractor.ejecutar(any(CrearUsuarioCommand.class))).thenReturn(UUID.randomUUID());
