...
@WebMvcTest(ConsultarCoordinadoresAdministradorController.class)
@Import({AppLoggerConfig.class, GlobalAppExceptionHandler.class, TrazabilidadConfig.class,
        ConsultarCoordinadoresAdministradorControllerTest.TestSecurityConfig.class})
class ConsultarCoordinadoresAdministradorControllerTest {

    private static final String RUTA = "/usuarios/coordinadores/administrador";
    ...
    @MockitoBean
    private ConsultarCoordinadoresAdministradorInteractor consultarCoordinadoresAdministradorInteractor;
    ...
    void debe200ConEstadoYVigente_cuandoBodyVacio() throws Exception {
        // Arrange
        var readModel = new CoordinadorReadModel(UUID.randomUUID(), "1001", "Ana Ramirez",
                "ana.ramirez@uco.edu.co", "3000000000", "INACTIVO", false);
        when(consultarCoordinadoresAdministradorInteractor.ejecutar(any(ConsultaCriteriaQuery.class)))
