...
@WebMvcTest(ConsultarAsesoresAdministradorController.class)
@Import({AppLoggerConfig.class, GlobalAppExceptionHandler.class, TrazabilidadConfig.class,
        ConsultarAsesoresAdministradorControllerTest.TestSecurityConfig.class})
class ConsultarAsesoresAdministradorControllerTest {

    private static final String RUTA = "/usuarios/asesores/administrador";
    ...
    @MockitoBean
    private ConsultarAsesoresAdministradorInteractor consultarAsesoresAdministradorInteractor;
    ...
    void debe200ConEstadoYVigente_cuandoBodyVacio() throws Exception {
        // Arrange
        var readModel = new AsesorReadModel(UUID.randomUUID(), "1001", "Ana Ramirez",
                "ana.ramirez@uco.edu.co", "3000000000", "INACTIVO", false);
        when(consultarAsesoresAdministradorInteractor.ejecutar(any(ConsultaCriteriaQuery.class)))
