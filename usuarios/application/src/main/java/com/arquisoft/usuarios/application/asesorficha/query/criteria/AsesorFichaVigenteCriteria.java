package com.arquisoft.usuarios.application.asesorficha.query.criteria;
...
public final class AsesorFichaVigenteCriteria extends QueryCriteria {
    ...
    private AsesorFichaVigenteCriteria(Builder b) {
        super(b);
    }
    ...
    public static final class Builder extends QueryCriteria.BaseBuilder<Builder> {
        ...
        public AsesorFichaVigenteCriteria build() {
            return new AsesorFichaVigenteCriteria(this);
        }
    }
}
