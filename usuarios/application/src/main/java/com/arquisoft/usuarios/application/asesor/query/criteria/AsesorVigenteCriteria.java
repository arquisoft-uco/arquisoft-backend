package com.arquisoft.usuarios.application.asesor.query.criteria;
...
public final class AsesorVigenteCriteria extends QueryCriteria {
    ...
    private AsesorVigenteCriteria(Builder b) {
        super(b);
    }
    ...
    public static final class Builder extends QueryCriteria.BaseBuilder<Builder> {
        ...
        public AsesorVigenteCriteria build() {
            return new AsesorVigenteCriteria(this);
        }
    }
}
