...
public final class CoordinadorCriteria extends QueryCriteria {
    ...
    private CoordinadorCriteria(Builder b) {
        super(b);
    }
    ...
    public static final class Builder extends QueryCriteria.BaseBuilder<Builder> {
        ...
        public CoordinadorCriteria build() {
            return new CoordinadorCriteria(this);
        }
    }
}
