...
public final class EstudianteVigenteCriteria extends QueryCriteria {
    ...
    private EstudianteVigenteCriteria(Builder b) {
        super(b);
    }
    ...
    public static final class Builder extends QueryCriteria.BaseBuilder<Builder> {
        ...
        public EstudianteVigenteCriteria build() {
            return new EstudianteVigenteCriteria(this);
        }
    }
}
