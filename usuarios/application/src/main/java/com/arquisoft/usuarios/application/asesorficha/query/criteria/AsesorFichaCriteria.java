...
public final class AsesorFichaCriteria extends QueryCriteria {
    ...
    private AsesorFichaCriteria(Builder b) {
        super(b);
    }
    ...
    public static final class Builder extends QueryCriteria.BaseBuilder<Builder> {
        ...
        public AsesorFichaCriteria build() {
            return new AsesorFichaCriteria(this);
        }
    }
}
