package com.arquisoft.usuarios.application.coordinador.query.criteria;
...
public final class CoordinadorVigenteCriteria extends QueryCriteria {
    ...
    private CoordinadorVigenteCriteria(Builder b) {
        super(b);
    }
    ...
    public static final class Builder extends QueryCriteria.BaseBuilder<Builder> {
        ...
        public CoordinadorVigenteCriteria build() {
            return new CoordinadorVigenteCriteria(this);
        }
    }
}
