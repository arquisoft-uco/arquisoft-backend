...
class ConsultarEstudiantesAdministradorInteractorImplTest {

    @Mock
    private ConsultarEstudiantesAdministradorUseCase useCase;

    @InjectMocks
    private ConsultarEstudiantesAdministradorInteractorImpl interactor;
    ...
    void debeMapearLaEntradaYDelegarEnElUseCase_yRetornarSuResultado() {
        ...
        var esperado = PaginatedResult.<EstudianteReadModel>of(List.of(), 1, 15, 0L);
        ...
        var captor = ArgumentCaptor.forClass(EstudianteCriteria.class);
